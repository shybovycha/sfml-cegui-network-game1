...
void Map::PlayerAttack(int x, int y, int PlayerIndex)
{
	...
	if ((x >= Players[PlayerIndex].GetXCell() - Players[PlayerIndex].GetARadius() && x <= Players[PlayerIndex].GetXCell() + Players[PlayerIndex].GetARadius()) &&
		(y >= Players[PlayerIndex].GetYCell() - Players[PlayerIndex].GetARadius() && y <= Players[PlayerIndex].GetYCell() + Players[PlayerIndex].GetARadius()) &&
...
void Map::PlayerMove(int x, int y, int PlayerIndex)
{
	...
	if ((x >= Players[PlayerIndex].GetXCell() - Players[PlayerIndex].GetWRadius() && x <= Players[PlayerIndex].GetXCell() + Players[PlayerIndex].GetWRadius()) &&
		(y >= Players[PlayerIndex].GetYCell() - Players[PlayerIndex].GetWRadius() && y <= Players[PlayerIndex].GetYCell() + Players[PlayerIndex].GetWRadius()) &&
		(x >= 0 && x < HalfMapCellSize * 2 && y >= 0 && y < HalfMapCellSize * 2))
	{
...
void Map::DrawPlayers(float time)
{
	...
	HighlightSquare(Players[0].GetXCell(), Players[0].GetYCell(), Players[0].GetWRadius(), sf::Color(1, 1, 0), 1);
	HighlightSquare(Players[0].GetXCell(), Players[0].GetYCell(), Players[0].GetARadius(), sf::Color(1, 0, 0), 2);
}